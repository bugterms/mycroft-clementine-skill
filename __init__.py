...
class ClementineMusicPlayerSkill(MycroftSkill):
    ...
    def initialize(self):
        ...
        self.register_intent(internals_clementine_jump_forward_skill_intent,
                             self.handle_internals_clementine_jumpForward_skill_intent)
        ...
        self.register_intent(internals_clementine_jump_backward_skill_intent,
                             self.handle_internals_clementine_jumpBackward_skill_intent)
        ...
        self.register_intent(internals_clementine_previous_skill_intent,
                             self.handle_internals_clementine_previous_skill_intent)

        internals_clementine_pause_skill_intent = IntentBuilder("clementinePauseKeywordIntent"). \
            require("clementinePauseKeyword").build()
        self.register_intent(internals_clementine_pause_skill_intent,
                             self.handle_internals_clementine_pause_skill_intent)
    ...
    def handle_internals_clementine_jumpForward_skill_intent(self, message):
        ...
        try:
            ...
            self.speak(
                "sorry, was not able to parse the amount of songs i should go forward. Your wrong nr was: " + nrOfSongs)
    ...
    def handle_internals_clementine_jumpBackward_skill_intent(self, message):
        ...
        try:
            ...
            self.speak(
                "sorry, was not able to parse the amount of songs i should go backward. Your wrong nr was: " + nrOfSongs)
